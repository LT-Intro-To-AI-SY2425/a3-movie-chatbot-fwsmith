...
pa_list: List[Tuple[List[str], Callable[[List[str]], List[Any]]]] = [
    ...
    (str.split("who directed movies in _"), director_by_year),
...
if __name__ == "__main__":
    ...
    assert sorted(search_pa_list(["who", "directed", "movies", "in", "1926"])
    ) == sorted(["fritz lang"]), "failed search_pa_list test 4"
